# HTML, CSS y Vanilla JS: Estructura de Carpetas y Archivos

Aprende a estructurar un proyecto web frontend con HTML, CSS y JavaScript puro organizando tus archivos y carpetas de forma ordenada, incluyendo directorios para: css (estilos), data (json), fonts, js (javascript), entre otros.
